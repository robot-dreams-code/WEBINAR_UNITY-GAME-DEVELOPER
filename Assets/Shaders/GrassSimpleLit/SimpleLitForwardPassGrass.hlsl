...
void setup()
{
    ...
    uint adjustedID = fmod(unity_InstanceID, _InstanceCount);
    DrawData drawData = _DrawData[adjustedID];
...
Varyings LitPassVertexSimple(Attributes input)
{
    ...
    output.instanceColor = half3(1.0, 1.0, 1.0);
